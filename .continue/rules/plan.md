---
description: Plan initiatives and epics (create new or expand existing)
argument-hint: [initiative-name] or [epic-path] or [description]
---
...
- Next step: Run `/generate-tasks` for each epic
